...
export class AppComponent {
  ...
  disciplinas = [
    ...
    new Disciplina(3, 'Inglês',  new Professor("Fabiano"), 'Aprender a língua inglesa propicia a criação de novas ' +
    ...
    new Disciplina( 4, 'Matemática',  new Professor("Fabio"), 'No Ensino Fundamental, essa área, por meio da ' +
    ...
    new Disciplina(5, 'Ciências',  new Professor("Fernando"), 'Ao estudar Ciências, as pessoas aprendem a respeito ' +
